...
<div class="container">
	<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-3">
		<div style="border: 1px solid #AFEC96; border-radius: 25px;padding: 20px 10px; margin-top: 25px;">
			<label style="display: block;margin-bottom: 15px;">寻找失主:</label>

			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/find?op=find" enctype="multipart/form-data" method="post">
				<div class="form-group">
					<div class="col-md-6 col-lg-12 has-success">
						<div class="input-group">
							<span class="input-group-addon">拾获物品</span>
				...
				<div class="form-group">
					<div class="col-md-6 col-lg-12 has-success">
						<div class="input-group">
							<span class="input-group-addon">拾获时间</span>
